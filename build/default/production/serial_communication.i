...
_Bool connect();
_Bool synchronize();
# 8 "serial_communication.c" 2
# 17 "serial_communication.c"
void usart_init() {
    TRISCbits.TRISC6 = 0;
    TRISCbits.TRISC7 = 1;
...
result_t usart_receive_byte(uint8_t *recv_byte) {
    ...
    while (!RCIF) {
        ...
        _delay((unsigned long)((1)*(20e6/4000000.0)));

        timeout++;
    }

    _Bool OERR = (_Bool) RCSTA & 0b10;
